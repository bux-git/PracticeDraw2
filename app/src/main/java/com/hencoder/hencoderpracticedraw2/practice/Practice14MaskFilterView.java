...
public class Practice14MaskFilterView extends View {
    ...
    BlurMaskFilter normal = new BlurMaskFilter(100, BlurMaskFilter.Blur.NORMAL);
    BlurMaskFilter inner = new BlurMaskFilter(400, BlurMaskFilter.Blur.INNER);
    BlurMaskFilter outer = new BlurMaskFilter(100, BlurMaskFilter.Blur.OUTER);
    BlurMaskFilter solid = new BlurMaskFilter(100, BlurMaskFilter.Blur.SOLID);
